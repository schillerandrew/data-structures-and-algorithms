...
const addExclamation = (arr) => {
  let exclamationsArray = [];
  arr.forEach( (string) => {
    exclamationsArray.push(string + '!');
  });
  return exclamationsArray;
};
...
const allUpperCase = (arr) => {
  let uppercasedArray = [];
  arr.forEach( (string) => {
    uppercasedArray.push(string.toUpperCase());
  });
...
const greeting = (word) => {
  let shoutingString = word.toUpperCase() + '!';
  return shoutingString;
};
